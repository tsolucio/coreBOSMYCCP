...
<head>
    ...
    <title><?php if(isset($GLOBALS['portal_title'])) echo $GLOBALS['portal_title']." - "; echo Language::translate(isset($module)?$module:'MYCcoreBOSCP'); ?></title>
    ...
    <link href="themes/default/assets/css/coreboscp.css" rel="stylesheet" type="text/css">
