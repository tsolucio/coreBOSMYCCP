...
?>
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li><a href="" data-toggle="modal" data-target="#changePassModal"> <?php echo Language::translate("LBL_CHANGE_PASSWORD"); ?></a><li>
                <li><a href="index.php?logout=1"><i class="fa fa-sign-out fa-fw"></i> <?php echo Language::translate("LNK_LOGOUT"); ?></a></li>
            </ul>
            <!-- /.navbar-top-links -->
