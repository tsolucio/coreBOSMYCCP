		...
		if(!isset($_REQUEST['pn'])){
			...
			if(isset($loaded_plugins[$pluginname])){
				...
				if(!$pluginsettings){
					...
					$customalert['message']='This plugin <b>require the coreBOS WS Api connection</b>, please ensure to put correct credentials (WS Api Username and Api Key) in the <a href="index.php">Portal Configuration</a> Page.';
				}
